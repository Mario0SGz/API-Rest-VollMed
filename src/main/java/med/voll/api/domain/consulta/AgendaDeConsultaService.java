...
import med.voll.api.domain.consulta.cancelacion.ValidadorDeCancelacionDeConsulta;
...
public class AgendaDeConsultaService {
    ...
    @Autowired
    private List<ValidadorDeCancelacionDeConsulta> validadoresCancelamiento;
